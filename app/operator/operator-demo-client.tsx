  ...
  switch (answer.status) {
    ...
    default:
      return (
        <div className="rounded-[1.75rem] border border-rose-200 bg-rose-50 px-5 py-6">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-rose-700">Technical failure</p>
          <h2 className="mt-3 text-3xl font-semibold tracking-[-0.06em] text-slate-950">Technical failure</h2>
          <p className="mt-3 text-sm leading-6 text-slate-700">
            The GuideSite turn failed before a product answer could be rendered.
          </p>
        </div>
      );
  }
