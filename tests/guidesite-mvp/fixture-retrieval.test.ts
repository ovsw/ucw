    ...
    [
      {
        ...
        sourceText: "Parents often need to assess Child Readiness by looking at prior sleepaway experience, separation confidence, self-care routines, social confidence, and willingness to ask adults for help.",
      },
      {
        ...
        sourceText: "The overnight Camp Program gives children a residential camp experience with cabin life, daily routines, staff supervision, outdoor activities, and age-aware support for first-time campers.",
      },
      {
        ...
        sourceText: "Cabin staff watch for homesickness, help children settle into routines, encourage participation, and escalate persistent distress to senior staff.",
      },
      {
        ...
        sourceText: "Camp contacts parents when staff need family context, when adjustment concerns persist, or when a wellbeing issue needs parent involvement.",
      },
    ],
  );
